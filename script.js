...
function pontuation() {
  ...
  const treeRandom = setInterval(() => {
    const randomTree = Math.floor(Math.random() * 4);
    if (randomTree == 0) {
      tree.src = "images/arv-02.png";
      tree.style.animation = "animation: tree 1.5s linear infinite"
    } else if (randomTree == 1) {
      tree.src = "images/arv3.png";
      tree.style.animation = "animation: tree 1.5s linear infinite"
      ...
      tree.style.animation = "animation: tree 1.5s linear infinite"
      tree.src = "images/sprite-0004.png";
    }
  }, 1500);
}
...
const loop = setInterval(() => {
  ...
  let charPositionl = +window.getComputedStyle(charMain).left.replace("px", "");
  ...
  if (
    ...
    let height = +window.getComputedStyle(gameScreen).height.replace("px", "");
